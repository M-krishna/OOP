...
print(BMW.__bases__, Audi.__bases__, Car.__bases__) # returns a tuple of base classes that a child class inherits
...
new_child_obj.x2()
print(MINewChildClass.__mro__) # reason why calling x1() prints function from parent_class_1. MRO(Method resolution order)
