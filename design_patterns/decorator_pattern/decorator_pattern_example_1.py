...
print(
    "Description", house_blend.getDescription()
)  # get the description of the Beverage
print("Cost", house_blend.cost())

# create a new condiment object
house_blend_with_milk_topping = Milk(
    house_blend
)  # pass the beverage you want to decorate
print(house_blend_with_milk_topping.getDescription())

house_blend_with_milk_and_mocha_toppings = Mocha(
    house_blend_with_milk_topping
)  # here we are topping the milk condiment with mocha
